...
const debugSendMasterPty = require("debug")("sshClientWrapperInsecure:sshExec_masterPty");
...
async function expect(hostInfo, cmd, expects, timeout) {
  ...
  try {
    const rt = await retryWrapper(fork.bind(null, hostInfo, sshCmd, args, timeout, null, [], compiledExpects), hostInfo);
    return rt;
  } catch (e) {
    if (typeof e.rt === "undefined") {
      throw e;
