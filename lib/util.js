...
const sanityCheck = (hostInfo) => {
  ...
  // these properties can have invalid value for JSON.
  // ajv will remove that at validation pahse becase of additionalProperties setting
  // so we keep them here and put back later.
  ...
  if (masterPty === null || typeof masterPty === "function") {
