...
const debug = require("debug")("sshClientWrapper:debug:interface");
const debugVerbose = require("debug")("sshClientWrapper:verbose:interface");
const { sshExec, canConnect, disconnect, expect } = require("./sshExec.js");
...
class SshClientWrapper {
  ...
  async execAndGetOutput(cmd, timeout = 0, rcfile = null, prependCmd = null) {
    ...
    let rt = null;
    try {
      rt = await sshExec(this.hostInfo, cmd, timeout, cb, rcfile, prependCmd);
    } catch (e) {
