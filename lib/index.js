...
import { isArrayOfString, sanityCheck } from "./util.js";
...
class SshClientWrapper {
  ...
  async send(src, dst, opt = [], timeout = 0) {
    ...
    return this.deps.send(this.hostInfo, src, dst, opt, timeout);
  }
  ...
  async recv(src, dst, opt = [], timeout = 0) {
    ...
    return this.deps.recv(this.hostInfo, src, dst, opt, timeout);
  }
